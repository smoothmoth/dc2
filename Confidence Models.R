...
#   pooled <- plm(Confidence ~ .-Month -Ward.name, data=data_useful, model="pooling")
...
re <- plm(formula_confidence, data = pdata_c, model = "between", effect='twoways')

wi_time <- plm(formula_confidence, data = pdata_c, model = "within", effect='time')
re_time <- plm(formula_confidence, data = pdata_c, model = "between", effect='time')

wi_cov <- plm(formula_confidence, data = pdata_nocovid_c, model = "within", effect='twoways')
re_cov <- plm(formula_confidence, data = pdata_nocovid_c, model = "between", effect='twoways')

wi_time_cov <- plm(formula_confidence, data = pdata_nocovid_c, model = "within", effect='time')
re_time_cov <- plm(formula_confidence, data = pdata_nocovid_c, model = "between", effect='time')
